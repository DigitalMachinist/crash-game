...
- Remember the player's name between rounds in the client
- Remember the player's most recent bet between rounds in the client
- Remember the player's auto-cashout setting between rounds in the client
